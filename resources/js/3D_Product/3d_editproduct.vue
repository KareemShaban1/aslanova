            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ $t('Edit Products 3d') }}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form" @submit.prevent="update">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12 col-lg-3">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="name" class="form-control"
                                            placeholder="name" v-model="fetchData.name" />
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 col-lg-3">
                                    <div class="mb-1">
                                ...
                                <div class="col-md-6 col-12 col-lg-3">
                                    <div class="mb-1">
                                        <label class="form-label" for="capital">{{ $t('Model Id') }}</label>
                                        <input type="number" id="capital" class="form-control" placeholder="model id"
                                            v-model="fetchData.model_id" />
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 col-lg-3">
                                    <div class="mb-1">
                                ...
                                <div class="col-md-6 col-12 col-lg-3">
                                    <div class="mb-1">
                                        <label class="form-label" for="price">{{ $t('shipping price') }}</label>
                                        <input type="number" id="price" class="form-control" placeholder="Shipping Price"
                                            v-model="fetchData.shipping_price" />
                                    </div>
                                </div>
                                <div class="col-md-6 col-12 col-lg-3">
                                    <div class="mb-1">
                                        <label class="form-label" for="price">{{ $t('delivery time') }}</label>
                                        <input type="text" id="price" class="form-control" placeholder="Delivery Price"
                                ...
                                <div class="row">
                                    <div v-if="!parsedImages || parsedImages.length === 0" class="col-12">
                                        <h5 class="text-center text-primary">{{ $t('No images available.') }}</h5>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <button class="btn btn-primary btn-prev waves-effect waves-float waves-light"
                                        @click="products_category(fetchData.category3d_id)">
...
export default {
    ...
    methods: {
        ...
        showProduct(id) {
            try {
                axios.get(`/api/products_3d/${id}`)
                    .then((response) => {
                        const fetchD = response.data.product;
                        console.log('sub-products f: ', fetchD);
                        this.fetchData.category3d_id = fetchD.category3d_id;
                        this.fetchData.prod3d_id = fetchD.id;
                        ...
                        this.fetchData.model_id = fetchD.model_id;
        ...
        update() {
            ...
            data.append("id", this.fetchData.prod3d_id);
            data.append("category3d_id", this.fetchData.category3d_id);
            data.append("name", this.fetchData.name);
            data.append("desc", this.fetchData.desc);
            data.append("model_id", this.fetchData.model_id);
            ...
            axios.post(`/api/products_3d/${this.id}`, data)
                .then((response) => {
