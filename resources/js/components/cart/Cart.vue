    ...
    <ul v-if="isOpen" class="custom-dropdown-menu" @click.stop>
      ...
      <li class="custom-scrollable-container">
        <div
          ...
          class="custom-no-items text-center"
        >
          <p>{{ $t("noItemsInCart") }}</p>
        </div>
        <div v-for="(item, id) in cartItems" :key="id" class="custom-list-item">
          <div class="custom-item-body">
            ...
            <div class="custom-quantity-controls">
              <button class="custom-btn-cart" @click="updateQuantity(id, -1)">
                -
              </button>
      ...
      <li
        class="custom-dropdown-footer"
        v-if="Object.keys(cartItems).length > 0"
      >
        <div class="custom-total d-flex flex-column justify-content-between">
          <div class="d-flex justify-content-between">
            <h6>{{ $t("items") }}:</h6>
            <h6 class="custom-total-price">
              {{ total }}
              <i class="fa-solid fa-euro-sign"></i>
            </h6>
          </div>
        ...
        <router-link to="/dashboard/cart" class="custom-checkout-btn">{{
          $t("viewCart")
        }}</router-link>
      </li>
    </ul>
