                    ...
                    <section id="ecommerce-products" class="grid-view">
                        <div class="card ecommerce-card" v-for="(prod, index) in paginatedProducts" :key="index">
                            ...
                            <div class="item-options text-center">
                                <button @click="view_sub_product(prod.id)" class="btn btn-light btn-wishlist">
                                    <i class="fa-solid fa-eye"></i>
                                    <span>{{ $t("showDetails") }}</span>
                                </button>
                                <button @click="addToCart(prod)" class="btn btn-primary btn-cart">
...
export default {
    ...
    methods: {
        ...
        view_sub_product(id) {
            this.$router.push({ name: "view_sub_product", params: { id } });
        },
        changePage(page) {
