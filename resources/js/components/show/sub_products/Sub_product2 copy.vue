            ...
            <div class="col-12">
              ...
              <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><router-link to="/dashboard/categories">{{ $t("Categories") }}</router-link>
                  </li>
                </ol>
              </div>
            </div>
      ...
      <div class="content-detached">
        <div class="content-body">
          ...
          <section id="ecommerce-products" class="grid-view">
            <div class="card ecommerce-card" v-for="(prod, index) in filteredProducts" :key="index">
              <div class="item-img text-center">
                <span @click="view_sub_product(prod.id)">
                  <img class="img-fluid card-img-top" :src="getUserImageSrc(prod.file)" alt="img-placeholder" />
                </span>
              </div>
              <div class="card-body">
                <h6 class="item-name">
