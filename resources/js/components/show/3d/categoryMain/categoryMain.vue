                    ...
                    <section id="ecommerce-products" class="grid-view">
                        <div class="card ecommerce-card" v-for="(cat, index) in paginatedProducts" :key="index">
                            <div class="item-img text-center">
                                <span @click="CategoryMain_category3d(cat.id)">
                            ...
                            <div class="item-options text-center">
                                <span @click="CategoryMain_category3d(cat.id)" class="btn btn-light btn-wishlist">
                                    <i class="fa-solid fa-eye"></i>
                                    <span>{{ $t('showCatygory3D') }}</span>
                                </span>
                            </div>
                        </div>
                    </section>
...
export default {
    ...
    methods: {
        ...
        CategoryMain_category3d(id) {
            this.$router.push(`/dashboard/categories3d/${id}`);
        },
