        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ $t("Offer Details") }}</h2>
                        ...
                        <div class="row my-2">
                            <div class="col-12 col-md-3 d-flex align-items-center justify-content-center mb-2 mb-md-0">
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <img :src="getUserImageSrc(sub_product.file)" class="img-fluid product-img"
                                        alt="product image" @click="openImageModal(sub_product.file)" />
                                </div>
                            </div>
                            ...
                            <div v-if="isImageModalOpen" class="image-modal" @click="closeImageModal">
                                <div class="modal-content">
                                    <img :src="getUserImageSrc(selectedImage)" class="modal-image" alt="modal image" />
                                </div>
                            </div>
                            <div class="col-12 col-md-3 my-2">
                                ...
                                <div>
                                    <button @click="addToCart(sub_product)" class="btn btn-primary btn-cart">
                                ...
                                <div class=" col-3">
                                    <div class="card text-center">
                                        <div class="card-body align-items-center">
                                            ...
                                            <p class="card-text">{{ sub_product.shipping_price }} <i
                    ...
                    <div class="card-body" v-if="Offers.length > 0">
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide related-prod" v-for="(prod, index) in Offers" :key="index">
                                    <span @click="show(prod.id)">
                                        ...
                                        <div class="item-meta">
                                            <p class="card-text text-primary mb-0">
                                                {{ prod.price }} <span><i class="fa-solid fa-euro-sign"></i></span>
                                            </p>
                                        </div>
                                    </span>
                                </div>
...
export default {
    ...
    data() {
        return {
            ...
            Offers: [],
            features: [
                { label: this.$t("Width"), value: '', unit: 'cm', icon: 'fa-solid fa-text-width' },
                { label: this.$t("Height"), value: '', unit: 'cm', icon: 'fa-solid fa-text-height' },
                { label: this.$t("Thickness"), value: '', unit: 'cm', icon: 'fa-solid fa-down-left-and-up-right-to-center' }
            ],
            extraFeatures: [
                { label: this.$t("Capital"), value: '', icon: 'fa-solid fa-circle-dollar-to-slot' },
