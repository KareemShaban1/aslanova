...
class EmailPaymentController extends Controller
{
    ...
    public function sendCartDetails(Request $request)
    {
        ...
        foreach ($cartItems as &$item) { // استخدم مرجع العنصر (&$item)
            ...
            $item['vat'] = $vatItem + $shippingVat; // إضافة الضريبة على الشحن
        ...
        $total_data = [
            'total_with_vat' => $totalPriceWithVat,
            'total_vat' => $totalVat,
            'total_without_vat' => $totalPriceWithVat + $shipping_price - $totalVat,
    ...
    public function cartDetails($payment_id)
    {
        ...
        return view('payment.email_success', compact('payments', 'total_vat', 'total_amount', 'total_total', 'total_shipping_price'));
    }
